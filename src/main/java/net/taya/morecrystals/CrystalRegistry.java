...
public class CrystalRegistry {
    ...
    public static void registerCrystalType(String crystalType) {
        ...
        DeferredBlock<Block> smallBud = registerBudBlock(crystalType, "small", CrystalBudBlock.GrowthStage.SMALL);
        DeferredBlock<Block> mediumBud = registerBudBlock(crystalType, "medium", CrystalBudBlock.GrowthStage.MEDIUM);
        DeferredBlock<Block> largeBud = registerBudBlock(crystalType, "large", CrystalBudBlock.GrowthStage.LARGE);
        DeferredBlock<Block> cluster = registerBudBlock(crystalType, "", CrystalBudBlock.GrowthStage.CLUSTER);
        
        // Register the budding crystal block itself
        DeferredBlock<Block> buddingCrystal = MoreCrystals.BLOCKS.register("budding_" + crystalType,
        ...
        CrystalSet crystalSet = new CrystalSet(
            buddingCrystal, smallBud, mediumBud, largeBud, cluster
        );
     ...
     */
    private static DeferredBlock<Block> registerBudBlock(String crystalType, String sizePrefix, CrystalBudBlock.GrowthStage stage) {
        String blockId = sizePrefix.isEmpty() ? 
                          crystalType + "_cluster" : 
                          sizePrefix + "_" + crystalType + "_bud";
                          
        // The CrystalBudBlock constructor now handles all the block properties
        return MoreCrystals.BLOCKS.register(blockId,
            () -> new CrystalBudBlock(BlockBehaviour.Properties.of(), stage));
    }
    ...
    public static class CrystalSet {
        ...
        public CrystalSet(DeferredBlock<Block> buddingBlock,
        ...
        public DeferredBlock<Block> getBuddingBlock() { return buddingBlock; }
        public DeferredBlock<Block> getSmallBudBlock() { return smallBudBlock; }
        public DeferredBlock<Block> getMediumBudBlock() { return mediumBudBlock; }
        public DeferredBlock<Block> getLargeBudBlock() { return largeBudBlock; }
        public DeferredBlock<Block> getClusterBlock() { return clusterBlock; }
    }
}