...
public class Config {
    ...
    private static final ModConfigSpec.IntValue GROWTH_CHANCE = BUILDER
        .comment("The chance (1 in X) that a budding crystal will attempt to grow during a random tick.",
